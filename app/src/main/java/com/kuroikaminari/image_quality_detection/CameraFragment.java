...
public class CameraFragment extends Fragment
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            File folder = new File(Environment.getExternalStorageDirectory() + File.separator + "DCIM" + File.separator + "Lesson");
            if (!folder.exists()) {
                folder.mkdirs();
            }

            mFile = new File(folder + "/" + ts + ".jpg");
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        view.findViewById(R.id.camera_btn_picture).setOnClickListener(this);
                    ...
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            try {
                                ...
                                Log.d(TAG, "max zoom nya : " + maxZoom);
